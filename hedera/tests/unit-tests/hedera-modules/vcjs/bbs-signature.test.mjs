...
import '../../../../../common/dist/index.js'; // warm the module graph (avoids the barrel init cycle when run in isolation)
...
import { VCJS } from '../../../../dist/vcjs/vcjs.js';
import { DocumentLoader } from '../../../../../common/dist/document-loader/base/document-loader.js';
import { DefaultDocumentLoader } from '../../../../../common/dist/document-loader/base/document-loader-default.js';
import {
    JWS_2020_V1_CONTEXT,
    JWS_2020_V1_URL,
} from '../../../../../common/dist/document-loader/base/contexts/jws-2020-v1.js';
import { HederaDidDocument } from '../../../../dist/vcjs/did/hedera-did-document.js';
import { LocalSchemaContextLoader } from '../../../../../common/dist/document-loader/local-schema-context-loader.js';
import { LocalDidLoader } from '../../../../../common/dist/document-loader/local-did-loader.js';
...
const fixtures = join(dirname(fileURLToPath(import.meta.url)), '../../../../../common/tests/fixtures/credentials');
