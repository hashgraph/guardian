...
export class OrgRoleDTO {
    ...
    @ApiProperty({
        type: [String],
        description: 'Subset of TOKEN_MINTING, TOKEN_RETIREMENT, TOKEN_TRANSFER, TOKEN_ASSOCIATE, TOKEN_DISSOCIATE, MEMBER_MANAGE',
        required: false,
...
export class UpdateOrgRoleDTO {
    ...
    @ApiProperty({
        type: [String],
        description: 'New permissions list — subset of TOKEN_MINTING, TOKEN_RETIREMENT, TOKEN_TRANSFER, TOKEN_ASSOCIATE, TOKEN_DISSOCIATE, MEMBER_MANAGE',
        required: false,
        example: ['TOKEN_MINTING', 'TOKEN_TRANSFER']
    })
    @IsOptional()
