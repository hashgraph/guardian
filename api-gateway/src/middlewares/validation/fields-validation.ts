...
const fieldsValidation = {
  ...
  baseTokenSerials: yup.array().of(yup.number())
    .min(1, 'The baseTokenSerials field must contains at least 1 item').required('The baseTokenSerials field is required'),
  oppositeTokenSerials: yup.array().of(yup.number())
    .min(1, 'The oppositeTokenSerials field must contains at least 1 item').required('The baseTokenSerials field is required'),
  requestId: yup.string().required('The request id field is required'),
  ...
  password_confirmation: yup.string().required('The password confirmation field is required')
