...
export class TaskManager {
    ...
    private static readonly expectationMap: Map<TaskAction, number> = new Map([
        [TaskAction.CREATE_POLICY, 7],
        [TaskAction.WIZARD_CREATE_POLICY, 7],
        [TaskAction.PUBLISH_POLICY, 12],
        [TaskAction.IMPORT_POLICY_FILE, 8],
        [TaskAction.IMPORT_POLICY_MESSAGE, 10],
        [TaskAction.PUBLISH_SCHEMA, 7],
        [TaskAction.IMPORT_SCHEMA_FILE, 2],
        [TaskAction.IMPORT_SCHEMA_MESSAGE, 2],
        [TaskAction.CREATE_SCHEMA, 5],
        [TaskAction.PREVIEW_SCHEMA_MESSAGE, 3],
        [TaskAction.CREATE_RANDOM_KEY, 2],
        [TaskAction.CONNECT_USER, 8],
        [TaskAction.PREVIEW_POLICY_MESSAGE, 3],
        [TaskAction.CREATE_TOKEN, 3],
        [TaskAction.ASSOCIATE_TOKEN, 3],
        [TaskAction.DISSOCIATE_TOKEN, 3],
        [TaskAction.GRANT_KYC, 3],
        [TaskAction.REVOKE_KYC, 3],
        [TaskAction.DELETE_POLICY, 2],
        [TaskAction.CLONE_POLICY, 4],
    ]);
