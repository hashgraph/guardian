 ...
 * `frontend/src/variables.scss`, and the favicon (Guardian's Hedera "H" mark)
 * is inlined as a base64 PNG data URI (sourced from
...
// Hedera "H" mark (white H on a black circle) — Guardian's brand favicon.
