...
To access table data in custom logic block, please check [Custom Logic Block & Tables](../../../schemas/schema-fields-reference/table-field/custom-logic-block-and-tables.md) for more details.
