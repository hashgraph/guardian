...
![Creating new Schema](<../../../../.gitbook/assets/1 (1) (1).png>)
...
![InterfaceStepBlock is added as cyclic\_container](<../../../../.gitbook/assets/3 (1) (1) (1).png>)

2.2 Add ‘**requestVcDocumentBlock**’ into the ‘_cyclic\_container_’

![Adding requestVcDocumentBlock into cyclic\_container](<../../../../.gitbook/assets/4 (1) (1) (1).png>)

2.3 Then select the previously created Schema

![Selecting already created Schema](<../../../../.gitbook/assets/5 (1) (1) (1).png>)

2.4 Select ‘New UUID’ to configure automatic generation of unique IDs for each document

![Selecting UUID](<../../../../.gitbook/assets/6 (1) (1).png>)
...
![Selecting DIALOG as Type](<../../../../.gitbook/assets/7 (1) (1).png>)
...
![Adding sendToGuardianBlock in container cyclic\_container](<../../../../.gitbook/assets/8 (1) (1) (1).png>)

3.2 Select data type and where to store the document

![Selecting Data Source and Type](<../../../../.gitbook/assets/9 (1) (1).png>)
