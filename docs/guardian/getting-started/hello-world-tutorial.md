...
# First steps with Guardian: A hello world tutorial

{% hint style="info" %}
**Overview of Tutorial 001 / Hello World**

This tutorial introduces you to core concepts after you first log in as a 'Standard Registry' user to a fresh installation of the open source Guardian.&#x20;

In this tutorial you will learn about,

* Creating Hedera testnet account credentials
* Importing the hello world policy from the Methodology Library
* Publishing the policy to testnet
* Sending data to the policy
* Inspecting verifiable credential documents
{% endhint %}
...
1. Navigate to the [Methodology Library](../../../Methodology%20Library/Tutorials/001-hello-world/)
...
* [Concept: Policies](../workspace/policies/)
* [Concept: Schemas](../workspace/schemas/)
