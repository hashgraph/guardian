...
**`PUT /tokens/{tokenId}/{username}/revoke-kyc`**

Unsets (revokes) the KYC flag for the specified user on the given Hedera token. Only users with the Standard Registry role are allowed to make this request.
