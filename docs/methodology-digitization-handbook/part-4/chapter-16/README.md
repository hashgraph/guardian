...
![Sample project view in Verra Project Hub](<../../../.gitbook/assets/image (13).png>)
...
![External MRV data example - Taken from Metered energy policy](<../../../.gitbook/assets/image-1 (5).png>)
...
![Click dry run on top of menu bar in policy editor UI](<../../../.gitbook/assets/image-2 (4).png>)
