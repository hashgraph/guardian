...
![External MRV data example - Taken from Metered energy policy](<../../../.gitbook/assets/image-1 (6) (1).png>)
...
![Click dry run on top of menu bar in policy editor UI](<../../../.gitbook/assets/image-2 (5) (1).png>)
