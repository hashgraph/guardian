...
![Example of good code using relevant field names](<../../../.gitbook/assets/image (8).png>)
...
![Schema JSON](<../../../.gitbook/assets/image-2 (2).png>)
...
![Schema UUID on bottom right](../../../.gitbook/assets/image-3.png)
