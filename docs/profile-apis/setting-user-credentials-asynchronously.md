...
**`PUT /api/v1/profiles/push/{username}`**

Sets Hedera credentials for the specified user asynchronously and returns a task identifier for polling the result.
