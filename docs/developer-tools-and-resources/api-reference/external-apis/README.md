...
* [Policy Grid Actions](../../../developer-tools/api-reference/guardian/standard-registry/policies/policy-grid-actions/) — discover and execute workflow actions (Approve/Reject) on policy grid records
