# Sends Data with Sync Events (Generic)

**`POST /external/sync-events`**

Sends a Verifiable Credential (VC) document and returns synchronous policy events. The target policy is resolved from fields within the request body.
