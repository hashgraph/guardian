...
export class StatisticDetailsComponent extends BaseDetailsComponent {
    tabs: any[] = ['overview', 'activity', 'raw'];
    overviewFields: OverviewFormField[] = [
        {
            label: 'details.statistic.overview.topic_id',
            path: 'topicId',
            link: '/topics',
        },
        {
            label: 'details.statistic.overview.policy_topic_id',
            path: 'options.policyTopicId',
            link: '/topics',
        },
        {
            label: 'details.statistic.overview.owner',
            path: 'options.owner',
        },
        {
            label: 'details.statistic.overview.name',
            path: 'options.name',
        },
        {
            label: 'details.statistic.overview.description',
    ...
    protected override loadData(): void {
        if (this.id) {
            this.loading = true;
            this.entitiesService.getStatistic(this.id).subscribe({
                next: (result) => {
