...
export class TopicsComponent extends BaseGridComponent {
    columns: any[] = [
        {
    ...
    protected loadData(): void {
        ...
        this.entitiesService.getTopics(filters).subscribe({
            next: (result) => {
    ...
    public override onOpen(element: any) {
        this.router.navigate([`/topics/${element.topicId}`]);
    }
}
