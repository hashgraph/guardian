...
@Component({
    selector: 'project-practices',
    templateUrl: './project-practices.component.html',
    styleUrls: [
        '../base-grid/base-grid.component.scss',
        './project-practices.component.scss',
    ],
    standalone: true,
    imports: [
        CommonModule,
...
export class ProjectPracticesComponent extends BaseGridComponent {
    columns: any[] = [
        {
    ...
    protected loadData(): void {
        ...
        this.entitiesService.getProjectPractices(filters).subscribe({
            next: (result) => {
    ...
    protected loadFilters(): void {
        ...
        this.entitiesService.getProjectPracticesFilters().subscribe({
            next: (result) => {
