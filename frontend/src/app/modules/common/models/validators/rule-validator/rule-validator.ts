import { IConditionFormula, IConditionRange, IConditionText, IConditionEnum } from '@guardian/interfaces';
import { IRuleData } from './interfaces/rule';
import { FieldRuleResult } from './interfaces/status';
import { Formula } from '../utils/formula';
import { FormulaType } from './interfaces/formula-type';
