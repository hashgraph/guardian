import { NavItemType, IVariableData, IScoreData, IFormulaData, IStatisticItemConfig, GenerateUUIDv4 } from '@guardian/interfaces';
...
export class StatisticItemValidator {
    ...
    public updateVariables() {
        for (const variable of this.variables) {
            ...
            variable.isArray = Array.isArray(value);
