...
context("Policy autotest", { tags: ['policyAT'] }, () => {
    ...
    it("Run test for iRec 10 (new trust-chain)", () => {
        //import policy with tests
        cy.readFile("../Methodology Library/iREC/Policies/iRec Policy 10 (Recipient) (new trust-chain) (1707134204.675006033).policy", "binary")
