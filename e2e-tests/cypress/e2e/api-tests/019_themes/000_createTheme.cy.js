...
context('Create Policy Themes', { tags: ['themes', 'secondPool', 'all', 'all-no-mgs'] }, () => {
    ...
    it('Create theme without auth token - Negative', () => {
        cy.request({
            method: METHOD.POST,
            url: API.ApiServer + API.Themes,
            body: {
    ...
    it('Create theme with invalid auth token - Negative', () => {
        cy.request({
            method: METHOD.POST,
            url: API.ApiServer + API.Themes,
            body: {
    ...
    it('Create theme with empty auth token - Negative', () => {
        cy.request({
            method: METHOD.POST,
            url: API.ApiServer + API.Themes,
            body: {
