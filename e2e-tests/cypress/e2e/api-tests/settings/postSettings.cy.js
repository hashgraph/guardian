                ...
                .then((response) => {
                    ...
                    cy.request({
                        ...
                        body: {
                            ...
                            ipfsStorageApiKey: 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJkaWQ6ZXRocjoweDZlQUEyMUVkNDg0NTYyNTNhNDNBQ2VCMTFmZGE5MkEyNmJlMUM3YzQiLCJpc3MiOiJ3ZWIzLXN0b3JhZ2UiLCJpYXQiOjE2Nzg2OTYyOTkzMjQsIm5hbWUiOiJDZWx5YVRva2VuIn0.8Z_NZoOCh4_U_E9JucIIyuBTYcCn3LuQUlR3fJFIwlQ',
                        }
                    })
                        .then((response) => {
                            cy.request({
