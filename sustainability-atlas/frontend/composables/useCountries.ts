...
const _codeMap = new Map<string, string>(COUNTRIES.map(c => [c.code.toUpperCase(), c.name]));

/** Returns the regional-indicator flag emoji for a valid 2-letter ISO code, else ''. */
...
export function countryName(code?: string | null): string {
    ...
    return _codeMap.get(upper) ?? code;
}

/** Returns "<flag> <name>" trimmed (flag may be empty for legacy values). */
