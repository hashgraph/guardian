...
export enum MessageAPI {
    ...
    GET_SCHEMA_IWA_UPGRADE_PREVIEW = 'get-schema-iwa-upgrade-preview',
    UPGRADE_SCHEMA_TO_IWA_V3 = 'upgrade-schema-to-iwa-v3',
    ...
    CREATE_SCHEMA_TEMPLATE = 'CREATE_SCHEMA_TEMPLATE',
    CREATE_SCHEMA_TEMPLATE_VERSION = 'CREATE_SCHEMA_TEMPLATE_VERSION',
    GET_SCHEMA_TEMPLATES = 'GET_SCHEMA_TEMPLATES',
    GET_SCHEMA_TEMPLATE = 'GET_SCHEMA_TEMPLATE',
    GET_APPLIED_SCHEMA_TEMPLATE = 'GET_APPLIED_SCHEMA_TEMPLATE',
    CHECK_SCHEMA_TEMPLATE = 'CHECK_SCHEMA_TEMPLATE',
    UPDATE_SCHEMA_TEMPLATE = 'UPDATE_SCHEMA_TEMPLATE',
    DELETE_SCHEMA_TEMPLATE = 'DELETE_SCHEMA_TEMPLATE',
    PUBLISH_SCHEMA_TEMPLATE = 'PUBLISH_SCHEMA_TEMPLATE',
    PUBLISH_SCHEMA_TEMPLATE_ASYNC = 'PUBLISH_SCHEMA_TEMPLATE_ASYNC',
    SCHEMA_TEMPLATE_EXPORT_FILE = 'SCHEMA_TEMPLATE_EXPORT_FILE',
    SCHEMA_TEMPLATE_EXPORT_MESSAGE = 'SCHEMA_TEMPLATE_EXPORT_MESSAGE',
    SCHEMA_TEMPLATE_IMPORT_FILE_PREVIEW = 'SCHEMA_TEMPLATE_IMPORT_FILE_PREVIEW',
    SCHEMA_TEMPLATE_IMPORT_MESSAGE_PREVIEW = 'SCHEMA_TEMPLATE_IMPORT_MESSAGE_PREVIEW',
    SCHEMA_TEMPLATE_IMPORT_FILE_ASYNC = 'SCHEMA_TEMPLATE_IMPORT_FILE_ASYNC',
    SCHEMA_TEMPLATE_IMPORT_MESSAGE_ASYNC = 'SCHEMA_TEMPLATE_IMPORT_MESSAGE_ASYNC',
    APPLY_SCHEMA_TEMPLATE = 'APPLY_SCHEMA_TEMPLATE',
    DETACH_SCHEMA_TEMPLATE = 'DETACH_SCHEMA_TEMPLATE',
    PREVIEW_SCHEMA_TEMPLATE_DETACH = 'PREVIEW_SCHEMA_TEMPLATE_DETACH',
    PREVIEW_SCHEMA_TEMPLATE_UPDATE = 'PREVIEW_SCHEMA_TEMPLATE_UPDATE',
    UPDATE_APPLIED_SCHEMA_TEMPLATE = 'UPDATE_APPLIED_SCHEMA_TEMPLATE',
    ...
    SUGGESTIONS_GET_PROPERTIES = 'SUGGESTIONS_GET_PROPERTIES',
    ...
    DISCONNECT_EXTERNAL_POLICY = 'DISCONNECT_EXTERNAL_POLICY',
