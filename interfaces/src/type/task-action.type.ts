export enum TaskAction {
    ...
    CREATE_SCHEMA_TEMPLATE_VERSION = 'Create schema template version',
    DELETE_SCHEMA_TEMPLATE = 'Delete schema template',
    PUBLISH_SCHEMA_TEMPLATE = 'Publish schema template',
    IMPORT_SCHEMA_TEMPLATE_FILE = 'Import schema template file',
