    ...
    for (const src of sources) {
        ...
        if (!inbound) {
            messages.push({
                ...
                text: 'No inbound links for this block. Note: not all blocks necessarily require these.',
                blockType: type
            });
        }
        ...
        if (!outbound) {
            messages.push({
                ...
                text: 'No outbound links for this block. Note: not all blocks necessarily require these.',
                blockType: type
            });
        }
        ...
        if (!inbound && !outbound) {
            messages.push({
                ...
                text: 'No inbound and outbound links for this block. Note: not all blocks necessarily require both.',
                blockType: type
            });
        }
