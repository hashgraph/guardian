...
import { CompareOptions, IKeyMap, IWeightModel } from '../interfaces/index.js';
 ...
 */
export class VariableModel implements IWeightModel {
    /**
     * Model name
     * @public
     */
    ...
    public update(options: CompareOptions): void {
        ...
        weights.push(weight);
        weightMap[WeightType.GROUP_LVL_0] = weight;
     ...
     * @public
     */
    public equal(field: VariableModel, index?: number): boolean {
