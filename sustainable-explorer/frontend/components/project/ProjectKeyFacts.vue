...
<template>
    <div class="rounded-xl border bg-card overflow-hidden">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-px bg-border">
            ...
            <!-- Crediting Period -->
            <div class="bg-card px-5 py-4">
                <div class="text-[11px] font-medium text-muted-foreground uppercase tracking-wider mb-1">Crediting Period</div>
            ...
            <div class="bg-card px-5 py-4 sm:col-span-2">
                <div class="text-[11px] font-medium text-muted-foreground uppercase tracking-wider mb-1">Total Credits</div>
