import { ModuleAnalytics, ModuleOptions, Module } from '@indexer/interfaces';
...
export class ModuleDTO extends MessageDTO<
    ModuleOptionsDTO,
    ModuleAnalyticsDTO
> implements Module {}
...
export class ModuleDetailsDTO extends DetailsDTO<ModuleDTO> {}
export const ApiDetailsModuleResponse = applyDecorators(
    ApiExtraModels(ModuleDTO, ModuleOptionsDTO, ModuleAnalyticsDTO),
    ApiDetailsResponseWithDefinition('Module details', {
        allOf: [
            { $ref: getSchemaPath(ModuleDTO) },
            {
                properties: {
