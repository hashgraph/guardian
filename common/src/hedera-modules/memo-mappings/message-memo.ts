...
export class MessageMemo extends MemoMap {
    ...
    private static initMessageMap() {
        ...
        messageMemo[`${MessageType.SchemaTemplate}.${MessageAction.CreateSchemaTemplate}`] = 'Schema template creation message';
        messageMemo[`${MessageType.SchemaTemplate}.${MessageAction.PublishSchemaTemplate}`] = 'Schema template publishing message';
