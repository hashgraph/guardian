 ...
 * Schema message
 */
export class LabelMessage extends Message {
    /**
     * Name
     */
    public name: string;
     ...
     * To message object
     */
    public override toMessageObject(): LabelMessageBody {
        return {
            id: null,
            status: null,
            type: this.type,
     ...
     * @param message
     */
    public static fromMessage(message: string): LabelMessage {
        if (!message) {
            throw new Error('Message Object is empty');
        }

        const json = JSON.parse(message);
        return LabelMessage.fromMessageObject(json);
    }
     ...
     * @param json
     */
    public static fromMessageObject(json: LabelMessageBody): LabelMessage {
        if (!json) {
            throw new Error('JSON Object is empty');
        }

        let message = new LabelMessage(json.action);
