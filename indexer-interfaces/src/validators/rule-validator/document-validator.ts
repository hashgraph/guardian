import { DocumentFieldValidators } from './document-field-validators.js';
...
export class DocumentValidator {
    ...
    public static getCredentialSubject(document?: any): any {
        const credentialSubject: any = document?.credentialSubject;
