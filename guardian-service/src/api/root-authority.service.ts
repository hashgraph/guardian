...
export const rootAuthorityAPI = async function (
     ...
     */
    ApiResponse(channel, MessageAPI.GET_ROOT_CONFIG, async (msg, res) => {
     ...
     */
    ApiResponse(channel, MessageAPI.SET_ROOT_CONFIG, async (msg, res) => {
     ...
     */
    ApiResponse(channel, MessageAPI.GET_ADDRESS_BOOK, async (msg, res) => {
        if(!msg.payload) {
