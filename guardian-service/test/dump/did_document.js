...
module.exports.did_document = [{
    ...
    "_id": {
        "$oid": "616d72f82ef2bc00141bbe8e"
    },
    "did": "did:hedera:testnet:4AGt9SZtL2ybX9Hki9pqq3TgGSzy7BXh6XQLjPdinDku;hedera:testnet:fid=0.0.2276271",
    "document": {
        "@context": [
            "https://www.w3.org/ns/did/v1",
            "https://ns.did.ai/transmute/v1"
        ],
        "id": "did:hedera:testnet:4AGt9SZtL2ybX9Hki9pqq3TgGSzy7BXh6XQLjPdinDku;hedera:testnet:fid=0.0.2276271",
        "verificationMethod": [
            {
                "id": "did:hedera:testnet:4AGt9SZtL2ybX9Hki9pqq3TgGSzy7BXh6XQLjPdinDku;hedera:testnet:fid=0.0.2276271#did-root-key",
                "type": "Ed25519VerificationKey2018",
                "controller": "did:hedera:testnet:4AGt9SZtL2ybX9Hki9pqq3TgGSzy7BXh6XQLjPdinDku;hedera:testnet:fid=0.0.2276271",
                "publicKeyBase58": "AN93B6m1UWoTUMmnHjiZugPR6fPgV4zF83w7zUDngnXE"
            }
        ],
        "authentication": "did:hedera:testnet:4AGt9SZtL2ybX9Hki9pqq3TgGSzy7BXh6XQLjPdinDku;hedera:testnet:fid=0.0.2276271#did-root-key",
        "assertionMethod": [
            "#did-root-key"
        ]
    },
    "status": "CREATE",
    "createDate": {
        "$date": "2021-10-18T13:13:28.577Z"
    },
    "updateDate": {
        "$date": "2021-10-18T13:13:33.228Z"
    }
}, {
    "_id": {
